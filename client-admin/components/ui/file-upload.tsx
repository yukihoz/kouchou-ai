...
const FileUploadItem = React.forwardRef<HTMLLIElement, FileUploadItemProps>(function FileUploadItem(props, ref) {
  ...
  return (
    <ChakraFileUpload.Item file={file} ref={ref}>
      ...
      {clearable && (
        <ChakraFileUpload.ItemDeleteTrigger asChild onClick={() => onRemove?.()}>
    ...
    return (
      <ChakraFileUpload.ItemGroup ref={ref} {...rest}>
        {acceptedFiles.map((file) => (
          <FileUploadItem key={file.name} file={file} showSize={showSize} clearable={clearable} onRemove={onRemove} />
        ))}
